...
async def get_port(
    ...
    """Get port details."""
    return await port_svc.get(db, port_id)
...
async def update_port(
    ...
    """Update a port."""
    return await port_svc.update(db, port_id, body)
...
async def assign_port(
    ...
    return await port_svc.assign(db, port_id, body.member_id)
...
async def release_port(
    ...
    return await port_svc.release(db, port_id)
