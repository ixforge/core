"""Migrar los templates de los IXPs existentes al set euro-ix

Revision ID: 9f2c7a1b4d3e
Revises: 3786dfba4315
Create Date: 2026-09-10

El generador solo soporta bird.conf.j2: un IXP que quede con el set anterior
falla con TemplateNotFound al generar. Por eso esta migracion no es opcional
ni diferible, tiene que ir en el mismo deploy que el codigo.

El snapshot de abajo es una copia literal de services/default_templates.py al
momento de escribir esta migracion, a proposito: un template que cambie en el
futuro no debe cambiar lo que hizo esta revision.

ATENCION: para un IXP que venia con los templates viejos esto es un cambio de
...
revision: str = "9f2c7a1b4d3e"
down_revision: str | None = "3786dfba4315"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

EUROIX_TEMPLATE_SNAPSHOT: list[dict[str, object]] = [
    {
